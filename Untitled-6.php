...
$admin_user = "admin";      // Set admin username
$admin_pass = "admin123";   // Set admin password
...
.btn{background:#0b76ef;color:#fff;padding:10px 16px;border-radius:10px;display:inline-block}
